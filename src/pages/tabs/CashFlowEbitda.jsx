...
export default function CashFlowEbitda() {
    const { cash_flow_ebitda } = useSelector((state) => state.dataReducer)
    const temp = cash_flow_ebitda.map((dt) => dt.map((data) => (!isNaN(parseFloat(data)) ? parseFloat(data) : data)))
