...
export default function BaseIndicatorSummaryTable() {
    ...
    const BaseIndicatortTitle = base_financial_dashboard.find((dt) => dt[0] == 10103)
    const BaseIndicatorValues = base_financial_dashboard.filter(
    ...
    return (
        <div className="w-full flex flex-col">
            <div className="pt-2 px-1 pb-1 text-red-600 border-b-4 border-red-600 text-lg">
                <strong>{BaseIndicatortTitle[1]}</strong>
            </div>
