    ...
    return (
        <div className="">
            <Link
                ...
                } hover:no-underline flex rounded-md p-2 cursor-pointer dark:hover:bg-gray-500 dark:active:bg-gray-600 hover:bg-sky-700 text-white font-bold placeholder:text-sm items-center gap-x-4 active:bg-sky-600 ${
                    menu?.gap ? 'mt-9' : 'mt-2'
                }`}
            >
                {menu?.icon}
                            ...
                            <Link
                                ...
                                className={`${
                                    pathname === subMenuItem.path
                                        ? 'text-white dark:bg-gray-500 bg-sky-700'
                                        : 'text-white '
                                } hover:no-underline dark:hover:bg-gray-500 dark:active:bg-gray-600 hover:bg-sky-600 flex px-5 cursor-pointer items-center font-semibold rounded-md text-left p-2 text-sm text-gray-200 py-1`}
                            >
                                {subMenuItem?.icon}
