                                        ...
                                        <td
                                            className={classNames(
                                                ...
                                                dt[0] == 199 ||
                                                    ...
                                                    dt[0] == 499 ||
                                                    dt[0] == 599
                                                    ? 'bg-indigo-900 dark:bg-gray-900 text-indigo-50'
                                                    : null,
                                                // dt[0] == 299 ? 'bg-indigo-900 text-indigo-50' : null,
                                                dt[0] == 1000 || dt[0] == 2000 || dt[0] == 5000
                                                    ? 'bg-indigo-900 dark:bg-gray-900 text-indigo-50 font-bold'
                                                    : null,
                                                dt[0] == 3000
                                                    ? 'bg-indigo-800 dark:bg-gray-900 text-indigo-50 font-bold'
                                                    : null,
