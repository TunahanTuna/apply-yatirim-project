...
export default function BalanceTable({ table_sheet, title, setChartData }) {
    return (
        <div className="dark:bg-gray-700  dark:border-gray-900 bg-neutral-50 px-4 pt-3 pb-4 rounded-lg  border border-neutral-300 flex-1">
            ...
            <div className="mt-3 shadow-md  sm:rounded-lg">
                {table_sheet && (
                    <table className="w-full rounded-lg text-gray-700 table-auto">
